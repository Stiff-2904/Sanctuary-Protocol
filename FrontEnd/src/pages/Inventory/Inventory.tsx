      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
          <div style={{ background: "#1a1a1a", padding: "1rem", borderRadius: "8px", border: "1px solid #ffaa00" }}>
            ...
            <p style={{ color: "#ffaa00", fontSize: "1.5rem", fontFamily: "monospace" }}>{items.length}</p>
          </div>
        ...
        <div style={{ background: "#1a1a1a", borderRadius: "12px", padding: "1.5rem" }}>
          <h2 style={{ color: "#e0e0e0", fontFamily: "monospace", marginBottom: "1rem" }}>🗃️ Recursos en Bodega</h2>

          {loading && <p style={{ color: "#ffaa00", fontFamily: "monospace" }}>Cargando inventario...</p>}
          {error && <p style={{ color: "#ff3333", fontFamily: "monospace" }}>{error}</p>}
          {!loading && !error && items.length === 0 && (
            <p style={{ color: "#666", fontFamily: "monospace" }}>No hay recursos registrados en este campamento.</p>
          )}
          ...
          {items.map((item, index) => (
            <motion.div
              ...
              style={{
                ...
                padding: "1rem", borderBottom: "1px solid #333", gap: "1rem",
              }}
            >
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                {item.quantity <= item.min_quantity && <AlertTriangle size={16} color="#ff3333" />}
              </div>
            </motion.div>
          ))}
        </div>
          ...
          {showForm && (
            ...
            >
              <motion.div
                ...
                style={{
                  background: "#1a1a1a", border: "1px solid #ffaa00",
                  borderRadius: "12px", padding: "2rem",
                  width: "100%", maxWidth: "400px"
                }}
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                  <h2 style={{ color: "#ffaa00", fontFamily: "monospace" }}>📦 Agregar Recurso</h2>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  <div>
                    <label style={{ color: "#888", fontFamily: "monospace", fontSize: "0.85rem" }}>Recurso *</label>
                    <select
                  ...
                  <div>
                    <label style={{ color: "#888", fontFamily: "monospace", fontSize: "0.85rem" }}>Cantidad *</label>
                    <input
                      type="number"
                      value={form.quantity}
