...
export default function ResourceManagerDashboard() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0a" }}>
      <header style={{ background: "#1a1a1a", padding: "1rem 2rem", borderBottom: "1px solid #ffaa00", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ color: "#ffaa00", fontFamily: "monospace", fontSize: "1.5rem" }}>🧟 Sanctuary Protocol</h1>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <span style={{ color: "#888", fontFamily: "monospace" }}>{user?.username} — Resource Manager</span>
      ...
      <main style={{ padding: "2rem", maxWidth: "900px", margin: "0 auto" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h2 style={{ color: "#e0e0e0", fontFamily: "monospace", marginBottom: "0.5rem" }}>📦 Panel de Recursos</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "2rem" }}>
            {[
              ...
              { label: "Alertas activas", value: metrics?.critical_inventory ?? "—", color: "#ff3333" },
          ...
          <motion.div
            ...
            style={{ background: "#1a1a1a", border: "1px solid #ffaa00", borderRadius: "12px", padding: "2rem", cursor: "pointer", display: "flex", alignItems: "center", gap: "1.5rem" }}
          >
            <Package size={48} color="#ffaa00" />
            <div>
              <h3 style={{ color: "#ffaa00", fontFamily: "monospace", marginBottom: "0.25rem" }}>Gestión de Inventario</h3>
